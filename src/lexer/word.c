...
/*   Updated: 2025/10/21 18:43:01 by dajesus-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_word_info	handle_quote_extraction(char *input, int *i, char *result,
		char *first_quote)
{
	char		*word;
	char		*temp;
...
static t_word_info	process_character(char *input, int *i, char *result,
		char *first_quote)
{
	t_word_info	info;
