...
/*   Updated: 2025/10/21 18:41:32 by dajesus-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/minishell.h"

static int	handle_builtin_case(char **expanded_args, t_command *cmd,
		t_shell *shell)
{
	int	code;
...
static void	handle_child_process(t_command *cmd, char **expanded_args,
		t_shell *shell)
{
	int	exit_code;
...
int	exec_single_builtin_or_fork(t_command *cmd, t_shell *shell,
		char **expanded_args)
{
	int	builtin_result;
	int	result;
